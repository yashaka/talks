...
using TamingDinoFrameworksCs.TodoMVC.IntegratedToSeleniumBasedFramework.After.Core;
using NSelene;
using static NSelene.Selectors;
using NSelene.Support.Extensions;

namespace TamingDinoFrameworksCs.TodoMVC.IntegratedToSeleniumBasedFramework.AfterPlusAlternativeStyleOfPageFields.Pages
{
    public class Tasks : PageObject
    {
         ...
         * It would be even more consice, but less obvious, even when you are going to add other fields, 
